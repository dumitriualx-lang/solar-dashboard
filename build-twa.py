...
# settings.gradle — Gradle 8.7 + AGP 8.3 compatible
...
# root build.gradle — empty, plugins declared in app/build.gradle
write(os.path.join(ROOT, "build.gradle"), "// Top-level build file\n")

# gradle.properties — REQUIRED for AndroidX dependencies
